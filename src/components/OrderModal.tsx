export default function OrderModal() {
  return (
    <>
      <div className="fixed inset-0 bg-[#000] opacity-70"></div>
      <section className="left- fixed top-[10rem] z-20 w-full rounded-[2rem] border border-transparent bg-[#fff] p-12 md:left-[50%] md:top-[7rem] md:max-h-[50rem] md:w-[50rem] md:translate-x-[-50%]">
